    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '  </div>\n' +
                '</div>\n';
            tProgress = '<div class="progress" style="display:none; visibility:hidden">\n' +
            ...
            tIndicator = '<div class="file-upload-indicator" title="{indicatorTitle}" style="display:none; visibility:hidden">{indicator}</div>';
        ...
        _slugDefault: function (text) {
			...
			return $h.isEmpty(text, true) ? '' : text;
        },
