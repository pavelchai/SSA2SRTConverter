...
namespace SSA2SRT.Model.ZLib
{
    ...
    internal sealed class Deflater
    {
		...
		*/
        ...
        {
            if ((state & IS_FINISHING) != 0) throw new Exception("Finish() already called.");
        ...
        public int Deflate(byte[] output, int offset, int length)
        {
            ...
            {
                throw new Exception("Deflater is closed.");
            }
        ...
        {
            if (state != INIT_STATE) throw new Exception("State isn't inited.");
