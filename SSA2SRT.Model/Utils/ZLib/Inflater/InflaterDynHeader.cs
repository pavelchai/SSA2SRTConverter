...
namespace SSA2SRT.Model.ZLib
{
    internal sealed class InflaterDynHeader
    {
        ...
        private IEnumerable<bool> CreateStateMachine()
        {
            ...
            if (litLenCodeCount > LITLEN_MAX) throw new Exception("Invalid litLenCodeCount.");
            if (distanceCodeCount > DIST_MAX) throw new Exception("Invalid distanceCodeCount.");
            if (metaCodeCount > META_MAX) throw new Exception("Invalid metaCodeCount.");
            ...
            if (codeLengths[256] == 0)
                throw new Exception("Inflater dynamic header end-of-block code is missing.");
        ...
        public InflaterHuffmanTree LiteralLengthTree
        {
            get
            {
                if (litLenTree == null) throw new Exception("Header properties were accessed before header had been successfully read.");
                return litLenTree;
            }
        }
        ...
        public InflaterHuffmanTree DistanceTree
        {
            get
            {
                if (distTree == null) throw new Exception("Header properties were accessed before header had been successfully read.");
                return distTree;
            }
        }
